'''
# O processo a seguiir é todo feito no cmd (Terminal de comandos), para acessar aperte o botao windows e digita cmd
...
git pull  # Para puxar os arquivos modificados para o repositório no pc
'''
